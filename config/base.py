...
# Importing settings from custom apps
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        'NAME': 'BoutiqueEsmeraldaDB1',
        'HOST': 'DESKTOP-CAKRKLJ',
        # 'PORT': '1220',
        'OPTIONS': {
...
# Custom user model
AUTH_USER_MODEL = 'usuarios.User'  # Ensure this points to your custom User model
